...
class ModelBusinessLogicTest extends TestCase
{
    ...
    {
        $blockedSlot = new \App\Domain\Models\BlockedSlot();
    ...
    {
        $casts = (new \App\Domain\Models\BlockedSlot())->getCasts();
        $this->assertArrayHasKey('start_time', $casts);
        $this->assertArrayHasKey('end_time', $casts);
        $this->assertEquals('datetime', $casts['start_time']);
        $this->assertEquals('datetime', $casts['end_time']);
    ...
    {
        $this->assertTrue(method_exists(\App\Domain\Models\BlockedSlot::class, 'space'));
    }

    public function test_blocked_slot_overlapping_scope_exists(): void
    {
        $this->assertTrue(method_exists(\App\Domain\Models\BlockedSlot::class, 'scopeOverlapping'));
    }

    public function test_availability_day_name_accessor(): void
    {
        $availability = new \App\Domain\Models\Availability();
    ...
    {
        $this->assertTrue(method_exists(\App\Domain\Models\Availability::class, 'space'));
    }
