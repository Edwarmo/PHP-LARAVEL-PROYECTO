...
<template>
  ...
  >
    ...
    <h3 class="text-2xl font-light mb-3 text-foreground">
      {{ space.name }}
    </h3>
    ...
    <div class="flex items-end justify-between pt-4" style="border-top:1px solid var(--border)">
      <div>
        <p class="font-mono text-xs uppercase tracking-wider mb-1 text-muted-foreground">Precio/hora</p>
